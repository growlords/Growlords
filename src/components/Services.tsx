...
export default function Services({ onOpenProjectModal }: ServicesProps) {
  ...
  return (
    <section id="services" className="relative w-full py-32 bg-[#050505] text-white border-t border-white/5">
      {/* Background Subtle Gradient Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#B7FF3C]/5 blur-[140px] pointer-events-none rounded-full" />
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  data-cursor="view"
                  className="w-full py-8 md:py-10 px-4 md:px-8 flex items-center justify-between text-left transition-all duration-300"
                >
                  <div className="flex items-center gap-6 md:gap-12 flex-1">
                    <span className="text-xs md:text-sm font-mono tracking-widest text-white/40 group-hover:text-[#B7FF3C] transition-colors">
                      {service.number}
                    </span>

                    <h3
                      className={`text-2xl sm:text-4xl md:text-5xl font-bold uppercase tracking-tight font-heading transition-transform duration-300 group-hover:translate-x-2 ${
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className="px-4 md:px-8 pb-10 pt-2 grid grid-cols-1 lg:grid-cols-12 gap-8 border-t border-white/5">
                        {/* Left description */}
                        <div className="lg:col-span-6 flex flex-col justify-between">
                          ...
                          <div className="mt-6 p-4 rounded-xl border border-white/10 bg-[#111114] inline-flex items-center gap-3">
                            <div className="w-2 h-2 rounded-full bg-[#B7FF3C] animate-ping" />
                        ...
                        <div className="lg:col-span-6 flex flex-col justify-between">
                          <div>
                            <span className="text-[11px] font-mono tracking-widest text-[#B7FF3C] uppercase mb-3 block">
                              KEY DELIVERABLES
                            </span>
                          ...
                          <div className="mt-8 pt-4 flex items-center justify-between border-t border-white/10">
                            ...
                            <button
                              ...
                              data-cursor="open"
                              className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#B7FF3C] hover:text-[#D7FF7A] transition-colors"
                            >
