...
export default function About({ onOpenProjectModal }: AboutProps) {
  return (
    <section id="about" className="relative w-full py-32 bg-[#050505] text-white border-t border-white/5 overflow-hidden">
      {/* Ambience glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        {/* Top Tag */}
        <div className="inline-flex items-center gap-2 text-xs font-mono tracking-widest text-[#B7FF3C] uppercase mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-7">
            <h2 className="text-5xl sm:text-7xl md:text-8xl font-black uppercase tracking-tight font-heading leading-[0.9] text-white">
              WE'RE <br />
            ...
            <p className="mt-6 text-base sm:text-lg text-white/60 font-light leading-relaxed max-w-xl">
            ...
            <div className="mt-10 flex items-center gap-4">
              <button
                ...
                data-cursor="open"
                className="px-7 py-3.5 rounded-full bg-[#B7FF3C] text-[#050505] font-semibold text-xs uppercase tracking-wider flex items-center gap-2 hover:bg-[#D7FF7A] transition-all duration-300"
              >
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="p-6 rounded-2xl border border-white/10 bg-[#0A0A0C] hover:border-white/25 transition-colors">
              <div className="flex items-center gap-3 text-xs font-mono tracking-widest text-[#B7FF3C] uppercase mb-2">
                <Target className="w-4 h-4" />
                OUR MANDATE
              </div>
              <h3 className="text-lg font-bold uppercase font-heading text-white">
