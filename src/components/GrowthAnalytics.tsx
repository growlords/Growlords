...
import { TrendingUp, Activity, ArrowUpRight, ShieldCheck, Zap } from 'lucide-react';
...
export default function GrowthAnalytics() {
  ...
  return (
    <section id="analytics" className="relative w-full py-32 bg-[#050505] text-white border-t border-white/5">
      {/* Background Ambience */}
      <div className="absolute top-1/3 left-1/3 w-[600px] h-[400px] bg-[#B7FF3C]/5 blur-[180px] pointer-events-none rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          {analyticsMetrics.map((metric) => {
            ...
            return (
              <button
                ...
                data-cursor="view"
                className={`px-5 py-2.5 rounded-full text-xs font-mono uppercase tracking-wider transition-all duration-300 flex items-center gap-2 ${
                  isActive
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 p-6 sm:p-10 rounded-3xl border border-white/10 bg-[#0A0A0C] relative overflow-hidden flex flex-col justify-between">
            {/* Top Stat Ribbon */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <div>
                ...
                <div className="flex items-baseline gap-4 mt-2">
                  <span className="text-4xl sm:text-6xl font-extrabold font-heading text-white">
                    {currentMetric.headlineValue}
                  </span>
                  <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[#B7FF3C]/10 border border-[#B7FF3C]/30 text-[#B7FF3C] text-xs font-bold font-mono">
              ...
              <div className="text-left sm:text-right">
                <span className="text-[11px] font-mono text-[#B7FF3C] uppercase tracking-widest block">
          ...
          <div className="lg:col-span-4 p-8 sm:p-10 rounded-3xl border border-white/10 bg-[#0A0A0C] flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-2 text-xs font-mono tracking-widest text-[#B7FF3C] uppercase mb-4">
